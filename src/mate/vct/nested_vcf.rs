...
impl<P: ThresholdPolicy> VCTSolver<P> {
    pub fn solve_attacker_vcf(&mut self, state: &VCTState) -> Option<Mate> {
        if !state.attacking() {
            panic!()
        }
    ...
    pub fn solve_attacker_threat(&mut self, state: &VCTState) -> Option<Mate> {
        if state.attacking() {
            panic!()
        }
    ...
    pub fn solve_defender_vcf(&mut self, state: &VCTState) -> Option<Mate> {
        if state.attacking() {
            panic!()
        }
    ...
    pub fn solve_defender_threat(&mut self, state: &VCTState) -> Option<Mate> {
        if !state.attacking() {
            panic!()
        }
